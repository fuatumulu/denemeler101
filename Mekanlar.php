<?php
    ...
    $ToplamMekan = VeriSay('restoranlar', 'RestoranID', "RestoranUlkeID='$UlkeID'");
    $Limit = 12;
    ...
    $TumMekanlar = array();
    $Restoranlar = VerileriVer('restoranlar', false, "RestoranUlkeID='$UlkeID' AND RestoranDurum='1'", $Limit, "RestoranMekanAdi ASC", $Baslangic);
?>
...
?>
            ...
            <div class="row" style="margin-top:10px">
                <div class="twelve columns">
                    <b>
                        <a href="<?=$GenelAyarlar['SiteURL']?>">Home</a> - <?=$UlkeBilgisi['UlkeBaslik']?>
                    </b>
                </div>
            </div>

            <div class="row" style="margin-top:10px">
                <h1><b>Places in <?=$UlkeBilgisi['UlkeBaslik']?></b></h1>
            </div>
			...
			<main class="main-search-page" style="padding: 0; min-height: auto; border-radius: 15px; margin: 15px auto;">
				<div class="container" style=" min-height: auto; width: 100%">
					<div class="box" style="max-width: 95%;">
                        <form action="<?=$GenelAyarlar['SiteURL']?>/search" method="GET" class="pressed">
                ...
                <div class="twelve columns" style="margin-top:10px;border-bottom:1px solid #e1e1e1">
                    ...
                    <?php
                        ...
                        if ($AktifSayfa > 1) {
                            ...
                            echo '<a href="'.$GenelAyarlar['SiteURL'].'/'.$UlkeKisaKodu.'/1/" style="padding-right:10px">First</a>';
                        ...
                        for($x = ($AktifSayfa - 3); $x <= ($AktifSayfa + 3); $x++){
                            ...
                            if ($x > 0 && $x <= $ToplamSayfa ) {
                                ...
                                if ($x == $AktifSayfa) {
                                    ...
                                    echo '<a href="'.$GenelAyarlar['SiteURL'].'/'.$UlkeKisaKodu.'/'.$x.'/" style="padding-right:10px">'.$x.'</a>';
                        ...
                        if ($AktifSayfa < $ToplamSayfa) {
                            ...
                            echo '<a href="'.$GenelAyarlar['SiteURL'].'/'.$UlkeKisaKodu.'/'.$ToplamSayfa.'/" style="padding-right:10px">Last</a>';
