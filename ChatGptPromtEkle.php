			...
			<div class="x_panel">
				...
				<div class="x_content">
								...
								<?php
									...
									foreach ($Veriler as $Veri) {
										...
										?>
											...
											<option value="<?=$Veri['UlkeID']?>"><?=$Veri['UlkeBaslik']?></option>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<textarea class="form-control" name="PromtlarYorumlu" rows="5" placeholder="Promt Bilgisini Yazın (Yorumlu)"></textarea>
					...
					<div class="form-group" style="margin-top: 10px;">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<textarea class="form-control" name="PromtlarYorumsuz" rows="5" placeholder="Promt Bilgisini Yazın (Yorumsuz)"></textarea>
							<span style="color: #4193bb; font-size: 12px; padding: 5px; float: left;">Kullanılabilir Etiketler: {MekanAdi}, {Adres}, {Yorumlar}</span>
						</div>
