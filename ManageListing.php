...
<html lang="en">
                        ...
                        <div class="overlay-content container">
                            <div class="d-flex justify-content-between align-items-start flex-column flex-lg-row align-items-lg-end">
                                ...
                                <div class="text-white mb-4 mb-lg-0">
                                    <h1 class="text-shadow verified">Manage Listing</h1>
                                    ...
                                    <div class="text-block">
                                        <?php
                                            if (isset($_POST['Send'])) {
                                                ...
                                                echo '<h6 class="mb-3" style="text-align: center; color: green">Your application has been reviewed</h6>';

                                            }
                                        ?>
                                        
                                        <h3 class="mb-3" style="text-align: center;">Manage Listing</h3>

                                        <form action="" method="post" id="ManageList">
                                            <input type="text" name="Name" style="width: 100%; padding: 5px; border: 1px solid #ddd; border-radius: 3px; margin-bottom: 7px; font-size: 14px;" placeholder="Restaurant Name">
                                            <input type="text" name="MailAdress" style="width: 100%; padding: 5px; border: 1px solid #ddd; border-radius: 3px; margin-bottom: 7px; font-size: 14px;" placeholder="Mail Adress">
                                            <textarea style="width: 100%; padding: 5px; border: 1px solid #ddd; border-radius: 3px; margin-bottom: 7px; font-size: 14px;" rows="3" name="Address" placeholder="Restaurant Address"></textarea>
                                            <textarea style="width: 100%; padding: 5px; border: 1px solid #ddd; border-radius: 3px; margin-bottom: 7px; font-size: 14px;" rows="5" name="YourMenu" placeholder="Your Menu"></textarea>
                                            <button type="submit" name="Send" style="float: right;" class="btn btn-primary">Send</button>
                                        </form>                                        
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
        <script type="text/javascript">
            ...
            $('#ManageList').submit(function(){

                if ($('input[name=MailAdress]').val().length > 3 && $('input[name=MailAdress]').val().length > 3 && $('input[name=MailAdress]').val().length > 3 && $('input[name=MailAdress]').val().length > 3) {
