...
<html lang="en">
    ...
    })(window, document, "clarity", "script", "lyiu8lr1lb");
</script>
                        ...
                        <div class="overlay-content container">
                            <div class="d-flex justify-content-between align-items-start flex-column flex-lg-row align-items-lg-end">
                                ...
                                <div class="text-white mb-4 mb-lg-0">
                                    <h1 class="text-shadow verified"><?=$SayfaBilgisi['SayfaBaslik']?></h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="text-block">
                                        <h3 class="mb-3"><?=$SayfaBilgisi['SayfaBaslik']?></h3>
                                        <p class="text-muted"><?=$SayfaBilgisi['SayfaIcerik']?></p>
                                    </div>
                        ...
                        <div class="container">
                            <div class="align-items-center row">
                                <div class="text-center text-md-start col-md-6">
                                    ...
                                    <p class="text-sm mb-md-0" style="display: none;">© <?=date('Y')?>, Your company. All rights reserved. <a href="./manage-list">Manage List</a></p>
                                    <p class="text-sm mb-md-0" style="float: left; margin-right: 10px; width: 100%;">© <?=date('Y')?>, Your company. All rights reserved.</p>
